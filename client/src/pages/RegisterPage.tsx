  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-8">
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-lg">
        <h1 className="text-3xl font-semibold text-slate-900">Create your SmartTasks account</h1>
        <p className="mt-2 text-sm text-slate-600">Register to start managing projects and tasks.</p>
